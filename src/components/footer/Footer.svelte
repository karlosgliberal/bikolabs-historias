...
<!-- Footer-->
<div
  class="z-10 text-xs tablet:text-xs flex flex-row flex-wrap w-full absolute bottom-0 px-3  tablet:px-6 pt-12 pb-7 bg-gradient-to-b from-transparent to-stone-900 "
>
  <nav class="w-full flex gap-3 tablet:gap-5 ">
